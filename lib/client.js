...
Client.prototype.__defineGetter__('remoteAddress',function(){
    return this.socket.remoteAddress;
})

Client.prototype.__defineGetter__('remotePort',function(){
    return this.socket.remotePort;
})

Client.prototype.__defineGetter__('localAddress',function(){
    return this.socket.localAddress;
})

Client.prototype.__defineGetter__('localPort',function(){
    return this.socket.localPort;
})

Client.prototype.__defineGetter__('bytesRead',function(){
    return this.socket.bytesRead;
})

Client.prototype.__defineGetter__('bytesWritten',function(){
